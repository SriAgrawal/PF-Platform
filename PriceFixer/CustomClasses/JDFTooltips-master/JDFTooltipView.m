...
- (void)commonInit
{
    ...
    self.tooltipBackgroundColour = [UIColor blackColor];
    ...
    self.font = [UIFont fontWithName:@"Montserrat-Light" size:8.0f];
...
- (void)drawCanvas1WithFrame:(CGRect)frame;
{
    ...
    {
        //// Rectangle Drawing
        CGRect rect = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + 12, CGRectGetWidth(frame) - 28, CGRectGetHeight(frame) - 24);
